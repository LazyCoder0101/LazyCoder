...
public class CodeGenerationFrameOriV1 extends LazyCoderCommonFrame {
    ...
    private CodeGenerationFrameOriV1() {
...
//        contentPane.setBorder(new EmptyBorder(5, 5, 5, 5));
        ...
        codeOperationPanel = new CodeOperationPanel(null);
     ...
     * @param proInit
     */
    public CodeGenerationFrameOriV1(ProInit proInit) {
        this();
        ...
        //CodeGenerationFrameHolder.codeGenerationFrame = this;这里由于类型更改，且该版本为以前的版本，暂时屏蔽

        setTitle(CodeGenerationFrameHolder.projectName);
     ...
     * @param mainFileName
     */
    public CodeGenerationFrameOriV1(String projectParentPath, String projectName, ArrayList<ModuleRelatedParam> moduleRelatedParamList,
                                    String mainFileName) {
        this();
        CodeGenerationFrameHolder.currentEncodingType = SysService.SYS_PARAM_SERVICE.getEncoding();
    ...
    private void closingWindow() {
        this.addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent e) {
                int show = LazyCoderOptionPane.showConfirmDialog(null, "亲，确定要退出系统吗？", "系统提示", JOptionPane.YES_NO_OPTION);
