...
public class VariableBean extends VariableCodeElement implements LabelBean, CodeGenerateBeanInterface {
	...
	public static VariableBean restoreByJson(JSONObject elementJSONObject) {
		return JsonUtil.restoreByJSONObject(elementJSONObject, VariableBean.class);
	}
