...
public class TextInputBean extends TextInputCodeElement implements LabelBean, CodeGenerateBeanInterface {
	...
	public static TextInputBean restoreByJson(JSONObject elementJSONObject) {
		return JsonUtil.restoreByJSONObject(elementJSONObject, TextInputBean.class);
	}
