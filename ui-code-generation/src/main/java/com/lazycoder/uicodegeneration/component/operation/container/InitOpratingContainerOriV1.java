...
import com.lazycoder.uicodegeneration.component.operation.container.component.InitChoiceMenuOriV1;
...
public class InitOpratingContainerOriV1 extends AbstractCommandOpratingContainer {
...
//	private InitChoiceCombobox initChoiceCombobox;
    ...
    private InitChoiceMenuOriV1 initChoiceMenu;
     ...
     * @param expanded
     */
    public InitOpratingContainerOriV1(InitMetaModel metaModel, InitOperatingContainerParam initOperatingContainerParam, boolean expanded) {
        super();
     ...
     * @param expanded
     */
    public InitOpratingContainerOriV1(InitOpratingContainerModel model,
...
//        }
     ...
     * @param expanded
     */
    private InitOpratingContainerOriV1(boolean expanded) {
...
//				initChoiceCombobox = new InitChoiceCombobox(initList, this);
                initChoiceMenu = new InitChoiceMenuOriV1(initList, this);
