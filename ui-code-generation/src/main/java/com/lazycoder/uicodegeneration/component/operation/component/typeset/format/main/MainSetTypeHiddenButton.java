 ...
 */
public class MainSetTypeHiddenButton extends FoldButton {
	...
	public MainSetTypeHiddenButton(String MainSetTypeName, boolean expanded) {
		super(expanded);
		// TODO Auto-generated constructor stub
		setText(MainSetTypeName);
		setUI(new MainSetTypeHiddenButtonUI());
...
class MainSetTypeHiddenButtonUI extends FoldButtonUI {
