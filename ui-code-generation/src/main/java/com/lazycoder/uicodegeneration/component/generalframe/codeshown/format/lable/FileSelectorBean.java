...
public class FileSelectorBean extends FileSelectorCodeElement implements LabelBean, CodeGenerateBeanInterface {

	@Getter
	@Setter
	private String beanValue = "";

	public FileSelectorBean() {
		// TODO Auto-generated constructor stub
		super();
	}

	public static FileSelectorBean restoreByJson(JSONObject elementJSONObject) {
		return JsonUtil.restoreByJSONObject(elementJSONObject, FileSelectorBean.class);
	}
	...
	public void updateBeanValue(BaseLableElement opratingLabel, Object updateParam) {
		// TODO Auto-generated method stub
		FileSelectorControl fileSelectorControl = (FileSelectorControl) opratingLabel;
		if (isWrittenWithPath() == true) {
			String thePath= fileSelectorControl.getCodeInputPath(fileSelectorControl.getFilePath(), fileSelectorControl.getCodeInputShieldingPath(), fileSelectorControl.getFileSeparator()),
					text = thePath + fileSelectorControl.getFileSeparator() + updateParam;
			beanValue = text;
		} else {
			if (updateParam instanceof String) {
				this.beanValue = (String) updateParam;
