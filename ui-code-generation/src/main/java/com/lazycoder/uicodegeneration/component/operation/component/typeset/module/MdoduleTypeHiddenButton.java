 ...
 */
public class MdoduleTypeHiddenButton extends FoldButton {
	...
	public MdoduleTypeHiddenButton(String moduleTypeName, boolean expanded) {
		super(expanded);
		// TODO Auto-generated constructor stub
		setText(moduleTypeName);
		setUI(new MdoduleTypeHiddenButtonUI());
...
class MdoduleTypeHiddenButtonUI extends FoldButtonUI {
