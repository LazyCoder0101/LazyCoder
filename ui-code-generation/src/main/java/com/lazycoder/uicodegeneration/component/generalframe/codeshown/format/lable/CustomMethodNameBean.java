...
public class CustomMethodNameBean extends CustomMethodNameCodeElement
		implements LabelBean, CodeGenerateBeanInterface {

	@Getter
	@Setter
	private String beanValue = "";

	public CustomMethodNameBean() {
		// TODO Auto-generated constructor stub
		super();
	}

	public static CustomMethodNameBean restoreByJson(JSONObject elementJSONObject) {
		return JsonUtil.restoreByJSONObject(elementJSONObject, CustomMethodNameBean.class);
	}
