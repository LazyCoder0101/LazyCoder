 ...
 */
public class InitFunctionControlPanel extends AbstractFunctionControlInputPane {
    ...
    public InitFunctionControlPanel() {
    ...
    protected void addFunctionAddOpratingLabel() {
        if (DataSourceEditHolder.currentModule != null) {
            ...
            functionAddParam.setPaneType(MarkElementName.INIT_MARK);
    ...
    protected void addInfrequentlyUsedSettingOpratingLabel() {
        if (DataSourceEditHolder.currentModule != null) {
            ...
            infrequentlyUsedSettingParam.setPaneType(MarkElementName.INIT_MARK);
