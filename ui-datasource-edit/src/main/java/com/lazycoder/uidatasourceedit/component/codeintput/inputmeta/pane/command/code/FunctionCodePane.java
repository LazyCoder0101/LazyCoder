...
public class FunctionCodePane extends AbstractFunctionCodeInputPane {

	/**
	 *
	 */
	private static final long serialVersionUID = 3074681714898342735L;

	public FunctionCodePane(int serialNumber, ContainerModel model) {
