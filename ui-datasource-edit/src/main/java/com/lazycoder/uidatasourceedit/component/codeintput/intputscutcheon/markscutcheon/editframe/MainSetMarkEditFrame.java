...
public class MainSetMarkEditFrame extends AbstractMarkEditFrame {

    /**
     *
     */
    private static final long serialVersionUID = -2134094792059800661L;

    private JPanel contentPane;
    private MySpinner classSerialSpinner, commandSpinner, codeSerialSpinner;
    private MyButton okButton, cancelButton;
    private JLabel matchLabel;
    private MainSetMarkScutcheon markScutcheon;
     ...
     * Create the frame.
     */
    private MainSetMarkEditFrame() {
        super();
        setTitle("更改\"必填模板设置\"标记属性");
        init();
    }
     ...
     * @param markScutcheon
     */
    public MainSetMarkEditFrame(MainSetMarkScutcheon markScutcheon) {
        this();
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    MainSetMarkEditFrame frame = new MainSetMarkEditFrame();
    ...
    private void init() {
        setBounds(((int) SysUtil.SCREEN_SIZE.getWidth() / 2 - 280), ((int) SysUtil.SCREEN_SIZE.getHeight() / 2 - 280), 560, 570);
...
//        codeCodeLabelPanel.add(comboBox);
        ...
        OperatingTipButton operatingTip = new OperatingTipButton(SysFileStructure.getOperatingTipImageFolder(
                        "懒农数据源管理" + File.separator + "数据源编辑" + File.separator + "标记组件属性设置界面" + File.separator + "必填模板设置")
                .getAbsolutePath());
        ...
        this.addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent e) {
                MainSetMarkEditFrame.this.dispose();
            }
        });
    }
    ...
    private void setValue() {
        MainSetMarkElement markElement = markScutcheon.getMarkElement();
