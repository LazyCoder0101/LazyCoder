 ...
 */
public class MethodsFunctionControlPanel extends AbstractFunctionControlInputPane {
    ...
    public MethodsFunctionControlPanel() {
        super();
    ...
    protected void addFunctionAddOpratingLabel() {
        if (DataSourceEditHolder.currentModule != null) {
            ...
            functionAddParam.setPaneType(MarkElementName.FUNCTION_MARK);
    ...
    protected void addInfrequentlyUsedSettingOpratingLabel() {
        if (DataSourceEditHolder.currentModule != null) {
            ...
            infrequentlyUsedSettingParam.setPaneType(MarkElementName.FUNCTION_MARK);
    ...
    public File getImageRootPath() {
        File file = DatabaseFileStructure.getModulePictureFolder(SysFileStructure.getDataFileFolder(),
    ...
    public File getFileSelectorRootPath() {
        File file = DatabaseFileStructure.getModuleNeedFileFolder(SysFileStructure.getDataFileFolder(),
                GeneralHolder.currentUserDataSourceLabel.getDataSourceName(), DataSourceEditHolder.currentModule.getModuleId());
        return file;
    }
