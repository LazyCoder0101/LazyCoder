...
public class AdditionalSetMarkElement extends BaseMarkElement {
    ...
    public AdditionalSetMarkElement() {
        // TODO Auto-generated constructor stub
        setMarkType(MarkElementName.ADDITIONAL_SET_TYPE_MARK);
        codeLabelMatchingWeight = 4;
    }

    public static AdditionalSetMarkElement jsonParsing(JSONObject elementJSONObject) {
        return JSON.toJavaObject(elementJSONObject, AdditionalSetMarkElement.class);
    }
    ...
    public boolean matchThan(BaseMarkElement statementInformation) {
        AdditionalSetMarkElement setStatementInformation = (AdditionalSetMarkElement) statementInformation;
        boolean flag = true;
        if (this.ifCodeLabelIdIsNull()) {//这个标记没限制一定要写哪个标签
    ...
    @Override
    public AdditionalSetMarkElement clone() {
        AdditionalSetMarkElement markElement = (AdditionalSetMarkElement) super.clone();
        return markElement;
    }
