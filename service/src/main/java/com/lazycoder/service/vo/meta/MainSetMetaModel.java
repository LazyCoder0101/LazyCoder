...
@Data
@NoArgsConstructor
public class MainSetMetaModel extends AbstractMetaModel {

	/**
	 * 操作模型
	 */
	@JSONField(deserializeUsing = FormatTypeOperatingModelDeserializer.class)
	private FormatTypeOperatingModel operatingModel = FormatTypeOperatingModel.getMainFormatTypeOperatingModel();
