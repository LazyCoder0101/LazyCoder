...
public abstract class VirtualObject extends Bound {
     ...
     * It initialize foreground and background color to black
     ...
     * @param integerValue as object value
     */
     ...
     * @param foregroundColor as awt color
     */
    ...
    /**
     * Background color
     * @param backgroundColor as awt color
     */
     ...
     * @param image as swing ImageIcon
     */
    ...
    /**
     * The top of the object is selected
     * @param selectedTop set true if selected
     */
    ...
    /**
     * The mouse is at the top of the object
     * @param hoverTop true if mouse is over otherwise false
     */
